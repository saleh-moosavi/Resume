...
export default function Portfolio(props: { isDark: boolean }) {
  return (
    <div className="pb-20 px-10 md:px-20">
      <div className="flex items-center justify-between mb-10 lg:mb-16 p-3 md:p-5 bg-gray-900 dark:bg-gray-200 rounded-lg">
        <h1 className="md:text-3xl text-lg font-semibold select-none">
          Works
        </h1>
